...
namespace DotNetty.Buffers
{
    internal static partial class ThrowHelper
    {
        ...
        internal static void ThrowArgumentException(string message, ExceptionArgument argument)
        {
            ...
            static ArgumentException GetArgumentException(string message, ExceptionArgument argument)
            {
        ...
        internal static void ThrowInvalidOperationException(ExceptionResource resource, Exception e)
        {
            ...
            static InvalidOperationException GetInvalidOperationException(ExceptionResource resource, Exception e)
            {
