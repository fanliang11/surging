...
namespace DotNetty.Buffers
{
    ...
    sealed partial class PooledSlicedByteBuffer : AbstractPooledDerivedByteBuffer
    {
        ...
        static PooledSlicedByteBuffer NewInstance0(AbstractByteBuffer unwrapped, IByteBuffer wrapped, int adjustment, int length)
        {
            ...
            _ = slice.Init<PooledSlicedByteBuffer>(unwrapped, wrapped, 0, length, length);
            slice.DiscardMarks();
            slice._adjustment = adjustment;
        ...
        public sealed override ref byte GetPinnableMemoryAddress() => ref Unsafe.Add(ref Unwrap().GetPinnableMemoryAddress(), _adjustment);
        ...
        int Idx(int index) => index + _adjustment;
    }
}