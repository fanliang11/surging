...
namespace Surging.Core.System.Module
{
    ...
    public static class RegistrationExtensions
    {
        ...
        /// </summary>
        /// <param name="builder">The builder<see cref="ContainerBuilderWrapper"/></param>
        /// <param name="repositoriesAssemblies">The repositoriesAssemblies<see cref="Assembly[]"/></param>
        /// <returns>The <see cref="IRegistrationBuilder{object, ScanningActivatorData, DynamicRegistrationStyle}"/></returns>
        ...
        /// </summary>
        /// <param name="builder">The builder<see cref="ContainerBuilderWrapper"/></param>
        /// <param name="serviceAssemblies">The serviceAssemblies<see cref="Assembly[]"/></param>
        /// <returns>The <see cref="IRegistrationBuilder{object, ScanningActivatorData, DynamicRegistrationStyle}"/></returns>
