...
{
    /// <summary>
    /// Defines the <see cref="DefaultConsulClientProvider" />
    /// </summary>
    public class DefaultConsulClientProvider : IConsulClientProvider
    {
        ...
        /// <param name="consulAddressSelector">The consulAddressSelector<see cref="IConsulAddressSelector"/></param>
        /// <param name="logger">The logger<see cref="ILogger{DefaultConsulClientProvider}"/></param>
