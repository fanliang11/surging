...
{
    /// <summary>
    /// Defines the <see cref="SwaggerGenOptionsExtensions" />
    /// </summary>
    public static class SwaggerGenOptionsExtensions
    {
        ...
        /// <param name="securityScheme">The securityScheme<see cref="SecurityScheme"/></param>
        ...
        /// </summary>
        /// <param name="swaggerGenOptions"></param>
        /// <param name="requirement">The requirement<see cref="IDictionary{string, IEnumerable{string}}"/></param>
        ...
        /// </summary>
        /// <param name="swaggerGenOptions">The swaggerGenOptions<see cref="SwaggerGenOptions"/></param>
        /// <param name="operationIdSelector">The operationIdSelector<see cref="Func{ApiDescription, string}"/></param>
        ...
        /// </summary>
        /// <param name="swaggerGenOptions"></param>
        /// <param name="predicate">The predicate<see cref="Func{string, ApiDescription, bool}"/></param>
        ...
        /// <summary>
        /// The DocInclusionPredicateV2
        /// </summary>
        /// <param name="swaggerGenOptions">The swaggerGenOptions<see cref="SwaggerGenOptions"/></param>
        /// <param name="predicate">The predicate<see cref="Func{string, ServiceEntry, bool}"/></param>
      ...
      Func<string, ServiceEntry, bool> predicate)
        ...
        /// <summary>
        /// The GenerateSwaggerDoc
        /// </summary>
        /// <param name="swaggerGenOptions">The swaggerGenOptions<see cref="SwaggerGenOptions"/></param>
        /// <param name="entries">The entries<see cref="IEnumerable{ServiceEntry}"/></param>
      ...
      this SwaggerGenOptions swaggerGenOptions, IEnumerable<ServiceEntry> entries)
        ...
        /// <param name="includeControllerXmlComments">The includeControllerXmlComments<see cref="bool"/></param>
