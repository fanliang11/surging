...
namespace Surging.Core.CPlatform {
    ...
    internal class CPlatformResource {
        ...
        /// <summary>
        ///   查找类似 Format File Result Path Not Rooted 的本地化字符串。
        /// </summary>
        internal static string FormatFileResult_PathNotRooted {
            get {
                return ResourceManager.GetString("FormatFileResult_PathNotRooted", resourceCulture);
            }
        }
