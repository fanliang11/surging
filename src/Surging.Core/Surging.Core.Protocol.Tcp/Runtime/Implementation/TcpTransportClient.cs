...
{
    internal class TcpTransportClient : ITransportClient, IDisposable
    {
        #region Field
        ...
        public TcpTransportClient(IMessageSender messageSender, IMessageListener messageListener, ILogger logger)
        {
