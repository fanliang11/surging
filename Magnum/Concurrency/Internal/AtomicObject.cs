...
namespace Magnum.Concurrency.Internal
{
	...
	public class AtomicObject :
		Atomic<object>
	{
		public AtomicObject(object initialValue)
		{
			Value = initialValue;
		}
		...
		public override object Set(Func<object, object> mutator)
		{
			for (;;)
			{
				object originalValue = Value;

				object changedValue = mutator(originalValue);

				object previousValue = Interlocked.CompareExchange(ref Value, changedValue, originalValue);
