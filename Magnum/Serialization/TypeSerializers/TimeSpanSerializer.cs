...
namespace Magnum.Serialization.TypeSerializers
{
	...
	{
		public TypeReader<TimeSpan> GetReader()
		{
			return ParseShortestXsdDateTime;
		}

		public TypeWriter<TimeSpan> GetWriter()
		{
			return GetDateTimeOffsetString;
		}

		private static void GetDateTimeOffsetString(TimeSpan value, Action<string> output)
		{
			output(XmlConvert.ToString(value));
		}
